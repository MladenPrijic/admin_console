...
class Edit extends Component {
  ...
  async componentDidMount() {
    ...
    const servers = await this.fetch.get('/api/server/getAll');
    const { data } = await this.fetch(`/api/deployment/${this.deploymentId}`);
    this.setState({
      servers: servers.data.data.rows,
  ...
  handleOnSave = async e => {
    ...
    try {
      ...
      if (validation.isValid) {
        ...
        await this.fetch.post('/api/deployment/edit', data);
  ...
  render() {
    ...
    return (
      <Row>
          ...
          <Card>
            <CardHeader>Edit deployment</CardHeader>
            <CardBody>
              <Container>
                    ...
                    <Col>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          type="select"
                          name="type"
                          value={this.state.deployment.type}
                          onChange={this.handleOnChange}
